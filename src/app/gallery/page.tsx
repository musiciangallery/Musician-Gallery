...
export default async function GalleryPage() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 md:px-[52px] py-16">
      ...
      <p className="text-xs text-mid max-w-xl -mt-8 mb-12">
        The badge next to a Teacher&rsquo;s name means they&rsquo;ve
        independently completed a New Zealand Police Vetting Check through
        CVCheck &mdash; a real cost and process every vetted Teacher has
        chosen to undertake before their profile ever goes live.
      </p>
