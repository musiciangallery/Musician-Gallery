...
export async function ensureTables() {
  ...
  await Promise.all([
    ...
    // profile going live. content_edit_consent_at records when it was
    // given. Also carried over onto the musicians row at approval time
    // (see approve/route.ts) so the record survives even if this
