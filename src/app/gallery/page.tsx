...
export default async function GalleryPage() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 md:px-[52px] py-16">
      ...
      <p className="text-xs text-mid max-w-xl -mt-10 mb-12">
        ...
        cost and process every vetted Teacher has chosen to undertake
        before their profile shows on Musician Gallery.
      </p>
